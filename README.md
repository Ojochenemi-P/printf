...
This is a group project done by Abu Patience and Deborah Oguama
...
Use a local buffer of 1024 chars in order to 
...
Handle the following flag characters for 
non-custom conversion specifiers:

8. Sarcasm is lost in print
Handle the following length modifiers for 
non-custom conversion specifiers:
